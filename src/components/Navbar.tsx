    ...
    return (
      <div className="text-white/70 pt-6 bg-black">
            <div className="hidden md:flex items-center px-4 py-2 mx-auto max-w-[400px]">
                <ul className="flex flec-row p-4 space-x-8">
                    ...
                    <li>
                        <a href = "#contact" className="group">
                            <h1 className="text-mg fonr-bold text-white/70 cursor-pointer">Contact Me</h1>
            ...
            <motion.div
                ...
                className="fixed left-0 top-0 w-full z-40 bg-back/90"
            >
